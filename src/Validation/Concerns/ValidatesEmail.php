...
namespace Igniter\Flame\Validation\Concerns;
...
trait ValidatesEmail
{
     ...
     *
     * Laravel 5.8 and above, by default, uses the RFCValidation provider as the default validation.
     * We intend to use the FilterEmailValidation provider.
     *
