<div class="calendar-popover-content">
    ...
    <p>
        <b>@lang('igniter::admin.reservations.column_table'):</b>
        @verbatim
    ...
    <p>
        <b>@lang('igniter::admin.reservations.label_guest'):</b>
        @{{guest_num}}
    </p>
    <p>
        <b>@lang('igniter::admin.reservations.label_reservation_time'):</b>
        @{{reserve_time}} - @{{reserve_end_time}}
    </p>
    <p>
        <b>@lang('igniter::admin.reservations.label_customer_name'):</b>
