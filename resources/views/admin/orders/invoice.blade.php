...
<head>
    ...
    <title>{!! $model->invoice_number.' - '.lang('igniter::admin.orders.text_invoice').' - '.setting('site_name') !!}</title>
    {!! get_style_tags() !!}
    <style>
        body {
...
<div class="container-fluid p-5">
    <div class="row">
        <div class="col">
            <div class="invoice-title">
                <h3 class="pull-right">@lang('igniter::admin.orders.label_order_id')&nbsp;#{{$model->order_id}}</h3>
                <h2>@lang('igniter::admin.orders.text_invoice')</h2>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-6">
            <strong>@lang('igniter::admin.orders.text_restaurant')</strong><br>
    ...
    <div class="row">
        <div class="col-6">
            <p>
                <strong>@lang('igniter::admin.orders.text_customer')</strong><br>
                {{ $model->first_name.' '.$model->last_name.' ('.$model->email.')' }}
            </p>
            @if($model->isDeliveryType())
                <div>
                    <strong>@lang('igniter::admin.orders.text_deliver_to')</strong><br>
        ...
        <div class="col-3 text-left">
            <p>
                <strong>@lang('igniter::admin.orders.text_invoice_no')</strong><br>
                {{ $model->invoice_number }}
            </p>
            <p>
                <strong>@lang('igniter::admin.orders.text_invoice_date')</strong><br>
                {{ $model->invoice_date->format(lang('igniter::system.php.date_format')) }}<br><br>
            </p>
        </div>
        <div class="col-3 text-right">
            <p>
                <strong>@lang('igniter::admin.orders.text_payment')</strong><br>
                {{ $model->payment_method ? $model->payment_method->name : '' }}
            </p>
            <p>
                <strong>@lang('igniter::admin.orders.text_order_date')</strong><br>
                ...
                <table class="table table-bordered">
                    ...
                    <tr>
                        ...
                        <th class="text-left" width="65%">
                            <b>@lang('igniter::admin.orders.column_name_option')</b>
                        </th>
                        <th class="text-left"><b>@lang('igniter::admin.orders.column_price')</b></th>
                        <th class="text-right"><b>@lang('igniter::admin.orders.column_total')</b></th>
                    </tr>
                    </thead>
                    <tbody>
    ...
    <div class="row">
        <div class="col">
            <p class="text-center">@lang('igniter::admin.orders.text_invoice_thank_you')</p>
        </div>
    </div>
</div>
</body>
